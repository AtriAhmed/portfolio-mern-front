            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.rightCol}>
                    <View style={styles.section}>
                        ...
                        <Text style={styles.content}> I am Ahmed Atri, a software engineer specializing in full-stack web development. With freelance experience, I deliver successful projects on time and within budget. I prioritize data security and create responsive designs. Proficient in React / Next.js and ExpressJS / Laravel.</Text>
